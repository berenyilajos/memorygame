...
<div id="body">
	<div id="nav">
		<ul>
			...
			<li><a href="<%= request.getContextPath() %>/result">Results</a></li>
			<li><a class="active" href="<%= request.getContextPath() %>/result/<%= ((User)request.getSession().getAttribute("user")).getId() %>">My results</a></li>
			<li class="right" ><a href="<%= request.getContextPath() %>/logout">Logout</a></li>
		</ul>
	</div>
	<h3>My results (6x6)</h3>
	<% 
